...
<script language="javascript">
    ...
    function validarNombreUsuario(e) //mas punto guion barra baja
    {
        var key;
        ...
        if ((key < 48 || key > 57) && (key < 65 || key > 90) && (key < 97 || key > 122)&&(key!=45)&&(key!=46)&&(key!=95))
        {
            if(key == 8  || key == 11) // Detectar backspace (retroceso)
            { return true; } 
            else { return false; }
    ...
    function validarPassword(e) //mas punto guion barra baja
    {
        var key;
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          <ul class="nav navbar-nav">
            ...
            <li>              
              <a href="/aula-virtual/index.php/c_admin_grupos/">Grupos</a>                
            </li>

          </ul>

          <ul class="nav navbar-nav navbar-right">
            <li><a href="/aula-virtual/index.php/c_sesion/logout">Cerrar Sesión</a></li>
          </ul>
